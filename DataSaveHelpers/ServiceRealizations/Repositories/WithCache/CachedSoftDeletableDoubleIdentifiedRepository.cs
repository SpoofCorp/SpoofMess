...
public class CachedSoftDeletableDoubleIdentifiedRepository<T, TKey1, TKey2>(
    ICacheService cache,
    DbContext context,
    IProcessQueueTasksService processQueueTasks
    ) : CachedDoubleIdentifiedRepository<T, TKey1, TKey2>(
        cache,
        context,
        processQueueTasks
        ), ISoftDeletableDoubleIdentifiedRepository<T, TKey1, TKey2> where T : DoubleIdentifiedSoftDeletable<TKey1, TKey2>
{
